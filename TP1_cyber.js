...
function menu() {
    ...
    afficher("Encodage");
    saut(2);
    afficher("<input type=text id=texte placeholder='Mettez votre message à encoder/décoder ici' />");
    saut(2);
    afficher("César");
    saut();
    fonction("Encoder", "bouton_cesar_encrypte()", "cesar");
    afficher(" ");
    fonction("Décoder", "bouton_cesar_decrypte()", "cesar");
    saut(2);
    afficher("Vigenère");
    saut();
    fonction("Encoder", "bouton_vigenere_encrypte()", "vigenere");
    afficher(" ");
    fonction("Décoder", "bouton_vigenere_decrypte()", "vigenere");
    saut(2);
    afficher("Résultat");
    saut();
    div("resultat");
